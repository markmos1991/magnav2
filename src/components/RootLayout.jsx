        ...
        <div className="flex items-center gap-x-8">
          ...
          <button
            ...
            className={clsx(
              ...
              invert ? 'hover:bg-black/10' : 'hover:bg-neutral-950/10'
            )}
...
function Navigation() {
  return (
    <nav className="mt-px text-5xl font-medium tracking-tight text-white font-display">
      <NavigationRow>
        <NavigationItem href="/illustration">Illustration</NavigationItem>
        <NavigationItem href="/web">Web Design</NavigationItem>
      </NavigationRow>
      <NavigationRow>
        <NavigationItem href="/graphics">Graphics</NavigationItem>
        <NavigationItem href="/photography">Photography</NavigationItem>
      </NavigationRow>
    </nav>
  )
}
  ...
  return (
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      ...
      >
        ...
        >
          <GridPattern
            className="absolute inset-x-0 -top-4 -z-10 h-[1000px] w-full fill-sky-50 stroke-sky-20 -950/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
            yOffset={-96}
            interactive
          />
